...
import kotlinx.android.synthetic.main.city_layout.*

class CityFragment : BaseFragment(), CustomToolbar.CustomToolbarListener {
    override fun doBack() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener({
            getRoot().pushFragment(SexFragment(), true)
        })
    }
